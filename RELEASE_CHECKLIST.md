...
- Verify stable install works: `composer require arjundhi/magento2-catalog-grid-category-tools:^1.0`.
- Verify dev fallback works for pre-tag testing: `composer require arjundhi/magento2-catalog-grid-category-tools:"dev-main@dev"`.
